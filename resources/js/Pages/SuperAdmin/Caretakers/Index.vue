        ...
        <main class="h-full overflow-y-auto z-30">
          <div class="container px-6 mx-auto grid">
            <div class="flex justify-between items-center">
              ...
              >
                Here is a list of all caretakers. 
              </h2>

              <Link :href="route('caretakers.create')" class="px-8 cursor-pointer py-3 inline-block font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                Add New Caretaker
              </Link>
            </div>
                  ...
                  >
                    <tr v-for="user in users.data" :key="user.id" class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3 text-sm">
                         <Link :href="route('caretakers.show', user.id)">
                          {{ user.name }}
                        </Link>
                      </td>
                      <td class="px-4 py-3 text-sm">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <Link
                            ...
                            aria-label="Edit"
                            :href="route('caretakers.edit', user.id)"
                          >
                            Edit
                          </Link>
                          <Link
