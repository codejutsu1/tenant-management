          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              <Link
                ...
                :href="route('dashboard.super.admin')"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">CareTakers</span>
              </Link>
            </li>
            <li class="relative px-6 py-3">
              <Link
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                :href="route('super.admin.payment')"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">New Payments</span>
              </Link>
            </li>
            <li class="relative px-6 py-3">
              <Link
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                :href="route('show.tenants.yearly')"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              <Link
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                :href="route('landlord.change.room')"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">Change of Room</span>
              </Link>
            </li>
            <li class="relative px-6 py-3">
              <Link
